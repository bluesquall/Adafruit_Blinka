...
#
# SPI1 conflict with HDMI Audio on Black doed not have conflict on blue
#
...
#
# use pin designations consistent with blue & robotics cape
SPI1_SS1 = pin.SPI1_CS0
SPI1_SS2 = pin.SPI1_CS1
SPI1_SCK = pin.SPI1_SCLK
SPI1_MISO = pin.SPI1_D0
SPI1_MOSI = pin.SPI1_D1
